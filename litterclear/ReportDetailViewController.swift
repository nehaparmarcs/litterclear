...
class ReportDetailViewController: UIViewController,UIPickerViewDelegate, UIPickerViewDataSource, CLLocationManagerDelegate  {
    ...
    func pickerView(_ pickerView: UIPickerView, didSelectRow row: Int, inComponent component: Int) {
        ...
        if validDistance == true {
            ...
            let screenNameAlert  = UIAlertController(title: "Cannot update report", message: "Please be within 30 feet distance while updating", preferredStyle: UIAlertControllerStyle.alert)
